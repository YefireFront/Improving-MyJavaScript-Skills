...
*/
    ...
    */
    ...
    // const equipos =['RiBer', 'Boca Jrs', 'Racing'];
...
//      const rta = equipos.filter(item => item.length >= 6)
//      console.log(rta)
...
//       const rta2 = team.filter(item => item.bicampeon && item.nombre.length>=6)
//       console.log(rta2)
...
//       console.log(search('ca'))
    ...
    */
    ...
    //  const arr =  [1,2,5,4,5,6,7,8,5];

    //  let sum = 0;

    //  const rta = arr.reduce((sum, element)=> sum + element, 0);
    ...
    */
    ...
    //  const rta2 = arr.reduce((obj, element)=>{
    //      if(!obj[element]){
    //          obj[element] = 1;
    //      }else{
 ...
 */
    ...
    // const rta = equipos.some(item=> item.length>5);
    // console.log(rta)
    ...
    //           const rta2 = team.some(item => item.bicampeon == true);
    //           console.log(rta2)
 ...
 */
    ...
    //           const rta = team.every(item => item.Nhinchas > 100);
    //           console.log(rta);
 ...
 */
    ...
    // const rta = team.find(item=> item.bicampeon === true)
    // console.log(rta)
